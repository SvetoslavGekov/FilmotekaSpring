...
<link rel="stylesheet" href="static/css/html_slider.css">
  ...
  <div id="error" class="w3-container" style="max-width:100%">
    <div class="w3-panel w3-card w3-animate-zoom" style="max-width:100%">
      <div class="w3-center  w3-container "><br>
        <img src="static/img/error.jpg" alt="Error image" style="max-width:70%" class="w3-image w3-circle w3-margin-top">
      </div>
